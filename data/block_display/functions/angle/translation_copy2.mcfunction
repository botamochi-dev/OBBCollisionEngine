#execute if entity @e[tag=BDmenuselect,tag=BDmenu_angle_X] run data modify storage minecraft:block_display quaternion_combined set from storage minecraft:block_display quaternion_combined_X
#execute if entity @e[tag=BDmenuselect,tag=BDmenu_angle_Y] run data modify storage minecraft:block_display quaternion_combined set from storage minecraft:block_display quaternion_combined_Y
#execute if entity @e[tag=BDmenuselect,tag=BDmenu_angle_Z] run data modify storage minecraft:block_display quaternion_combined set from storage minecraft:block_display quaternion_combined_Z
# * BDselectのtranslationを修正する
#
