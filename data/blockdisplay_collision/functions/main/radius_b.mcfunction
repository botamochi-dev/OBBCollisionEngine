#* ブロックの投影半径を求める ( r = 0.5|Ax・L| + 0.5|Ay・L| + 0.5|Az・L| )
# X
data modify storage calc: in set value {}
data modify storage calc: in.x set value [1f,0f,0f]
...
# Y
data modify storage calc: in set value {}
data modify storage calc: in.x set value [0f,1f,0f]
data modify storage calc: in.y set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].TestAxis
function calc:main/dot_product
data modify storage calc: in set from storage calc: out
function calc:main/absolute_value
...
# Z
data modify storage calc: in set value {}
data modify storage calc: in.x set value [0f,0f,1f]
data modify storage calc: in.y set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].TestAxis
function calc:main/dot_product
data modify storage calc: in set from storage calc: out
function calc:main/absolute_value
...
function #math:float
data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Radius_B append from storage math: out.add