...
#* /function calc:main/vector_sub を実行して計算
...
#* 結果を渡す
execute store result storage calc: out[0] float 0.0001 run scoreboard players get $x1 number
execute store result storage calc: out[1] float 0.0001 run scoreboard players get $y1 number
execute store result storage calc: out[2] float 0.0001 run scoreboard players get $z1 number
execute store result storage calc: out[3] float 0.0001 run scoreboard players get $w1 number
